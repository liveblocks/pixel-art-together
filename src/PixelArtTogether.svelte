...
<div class="flex min-h-full bg-white relative">
  ...
  <div
    ...
    class="side-panel md:min-w-[320px] relative md:!relative md:!translate-x-0 md:!w-auto right-full overflow-y-auto w-0 md:right-auto md:w-auto flex-grow-0 flex-shrink-0 bg-white border-gray-100 {mobileMenuOpen ? 'border-r-2' : ''}"
  ...
  >
    {#if layers && canvasReady}
      <div transition:fade class="flex flex-col min-h-full">
