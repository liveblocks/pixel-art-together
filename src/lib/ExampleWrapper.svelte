      ...
      <div class="container mx-auto px-8">
        ...
        <ul class="list-disc list-inside">
          ...
          <li class="mb-2">
            ...
            <pre class="relative font-mono bg-black shadow-thin-border-300 rounded-lg my-4 text-sm text-gray-200 pt-2 px-4" style="min-height: 36px; line-height: 1.5em; max-width: 400px;"><code>{envVarName}=pk_live_yourkey</code></pre>
          </li>
          <li class="mb-2">
            Run
            <code class="relative font-mono bg-black shadow-thin-border-300 rounded-lg my-4 text-sm text-gray-200 px-2 py-1.5">
